...
所以，RAG 的重点不是“重新训练模型”，而是**在运行时给模型补充它当前真正需要的上下文**。在入门阶段，可以先把它记成一句话：
...
也就是说，RAG 不是“有知识库就一定答得好”，而是“知识库链路质量越高，回答越稳”。

---

## 2、知识库的概述

这一节从“产品使用者”的角度来理解知识库。你可以把知识库理解成：**把你的资料做成可检索、可引用、可被大模型调用的一套外部知识层。**
...
在入门阶段，ima 的价值主要是：**非常容易先建立“知识库问答”的使用直觉**。它的可定制化不如 Dify，但上手门槛更低。
