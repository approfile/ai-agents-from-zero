...
- `models` 关注“数据库表结构怎么映射成 Python 类”
- `entities` 关注“系统内部的业务对象怎么表示”
- `mappers` 关注“ORM 模型和业务实体之间如何转换”

也就是说，ORM 模型的重点不是“表达业务含义”，而是“描述这张数据库表长什么样、字段如何映射到 Python 对象”。
...
到这里你可以抓住一句最重要的话：**配置文件决定“同步什么”，入口脚本决定“从哪里进入”，服务层决定“具体怎么做”，ORM 模型负责“怎么和数据库表对上”。**
