...
- `shopkeeper-agent-backend/app/entities/table_info.py`
- `shopkeeper-agent-backend/app/entities/column_info.py`
...
- `shopkeeper-agent-backend/app/repositories/mysql/meta/mappers/table_info_mapper.py`
- `shopkeeper-agent-backend/app/repositories/mysql/meta/mappers/column_info_mapper.py`
